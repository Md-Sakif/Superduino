...
if MACOS_RESOURCES then
  ...
  DATADIR = prefix and (prefix .. PATHSEP .. 'share' .. PATHSEP .. 'superduino') or (EXEDIR .. PATHSEP .. 'data')
end
USERDIR = (system.get_file_info(EXEDIR .. PATHSEP .. 'user') and (EXEDIR .. PATHSEP .. 'user'))
       or os.getenv("LITE_USERDIR")
       or ((os.getenv("XDG_CONFIG_HOME") and os.getenv("XDG_CONFIG_HOME") .. PATHSEP .. "superduino"))
       or (HOME and (HOME .. PATHSEP .. '.config' .. PATHSEP .. 'superduino'))
