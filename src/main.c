...
int main(int argc, char **argv) {
  ...
  SDL_SetAppMetadata("Superduino", LITE_PROJECT_VERSION_STR, "io.github.md_sakif.Superduino");
...
init_lua:
  ...
  const char *init_lite_code = \
    ...
    "  dofile((MACOS_RESOURCES or (prefix and prefix .. '/share/superduino' or exedir .. '/data')) .. '/core/start.lua')\n"
    ...
    "  end\n"
    "  system.show_fatal_error('Superduino internal error',\n"
